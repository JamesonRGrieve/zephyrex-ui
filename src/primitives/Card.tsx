...
/** Surface container. All chrome is token-driven so it inherits the active theme. */
...
export function CardTitle({ className, ...props }: ComponentProps<'div'>): JSX.Element {
  return (
    <div data-slot='card-title' className={cn('text-lg font-semibold leading-none tracking-tight', className)} {...props} />
  );
}
